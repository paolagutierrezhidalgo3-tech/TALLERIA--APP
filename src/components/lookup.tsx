...
export function Lookup({kind,selected,label,disabled,onChange,find,initial}: {kind:'customer'|'request';selected:string;label:string;disabled?:boolean;onChange:(id:string)=>void;find:FindOptions;initial:LookupOption[]}) {
