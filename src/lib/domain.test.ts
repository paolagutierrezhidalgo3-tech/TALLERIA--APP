...
function appointment(state: State, starts_at = '2030-01-02T10:00:00Z'): Command { return { type: 'appointment', request_version: state.requests[0].version, id: crypto.randomUUID(), request_id: state.requests[0].id, starts_at, duration_minutes: 60, notes: '' }; }
